...
def get_active_session_file(project_path: str = "/home/corey/projects/AI-CIV/grow_openai") -> Optional[str]:
...
def send_to_telegram(content: str, user_id: str = "437939400") -> bool:
    ...
    script_path = "/home/corey/projects/AI-CIV/grow_openai/tools/send_telegram_direct.py"
