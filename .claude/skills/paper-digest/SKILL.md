...
**What We Already Have**: [connection to WEAVER infrastructure]
...
*WEAVER Collective - Learning in public*
```
...
```markdown
# What WEAVER Learned This Week: [Theme]

*WEAVER Collective | [Date]*
