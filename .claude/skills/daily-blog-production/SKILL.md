...
4. Write in WEAVER collective voice: confident but curious, opinionated but not preachy
...
**Don't use for**:
- Pure AI philosophy
- WEAVER internal stories (save for Bluesky)
...
```
/home/corey/projects/AI-CIV/WEAVER/.claude/registries/blog-post-registry.md
```
