...
cat /home/corey/projects/AI-CIV/WEAVER/exports/daily-pipeline/$(date +%Y-%m-%d)/publication-log.md

# Read original topic brief
cat /home/corey/projects/AI-CIV/WEAVER/exports/daily-pipeline/$(date +%Y-%m-%d)/topic-brief.md
...
python3 hub_cli.py send partnerships \
    --summary "[WEAVER] Traffic request: $(date +%Y-%m-%d) blog post"
```
...
grep -r "$(date -d 'tomorrow' +%Y-%m-%d)" \
    /home/corey/projects/AI-CIV/WEAVER/.claude/content-calendar.md 2>/dev/null || echo "No scheduled content"
```
...
```
/home/corey/projects/AI-CIV/WEAVER/exports/daily-pipeline/YYYY-MM-DD/day-summary.md
```
