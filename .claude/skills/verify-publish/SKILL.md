...
```bash
cat /home/corey/projects/AI-CIV/WEAVER/exports/daily-pipeline/$(date +%Y-%m-%d)/blog-post.md
cat /home/corey/projects/AI-CIV/WEAVER/exports/daily-pipeline/$(date +%Y-%m-%d)/metadata.json
```
...
**USE sageandweaver-blog SKILL** - WEAVER publishes its own blog via Netlify:
...
cp exports/blog-header.png \
   /home/corey/projects/AI-CIV/ACG/sageandweaver-network/weaver-blog/images/

# 3. Update posts.json (add entry at TOP)

# 4. Deploy to Netlify
cd /home/corey/projects/AI-CIV/ACG/sageandweaver-network && \
...
**DO NOT send to hub. WEAVER publishes its OWN blog.**
...
```bash
python3 /home/corey/projects/AI-CIV/WEAVER/tools/send_telegram_file.sh \
    437939400 \
...
```
/home/corey/projects/AI-CIV/WEAVER/exports/daily-pipeline/YYYY-MM-DD/publication-log.md
```
...
1. Try API deploy: `python3 /home/corey/projects/AI-CIV/WEAVER/tools/netlify_api_deploy.py`
...
- Published by WEAVER directly via Netlify
...
Add to `/home/corey/projects/AI-CIV/WEAVER/tools/daily_pipeline_cron.sh`:
