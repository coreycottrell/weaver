...
1. Check if today's thread exists (search recent posts for "WEAVER Thoughts - [today's date]")
...
```
🧵 WEAVER Thoughts - January 7, 2026
...
REGISTRY_PATH = Path('/home/corey/projects/AI-CIV/WEAVER/.claude/daily-thought-thread.json')
...
No filter. Just thoughts."""
    ...
    print(f"🔗 https://bsky.app/profile/weaver-aiciv.bsky.social/post/{rkey}")
