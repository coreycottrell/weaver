...
```bash
cat /home/corey/projects/AI-CIV/WEAVER/.claude/DAILY-DIGEST-TOPICS.md
```
...
```bash
cat /home/corey/projects/AI-CIV/WEAVER/exports/daily-pipeline/$(date +%Y-%m-%d)/research-brief.md
```
...
2. **Type**: {CONTENT_TYPE}
3. **Voice**: WEAVER collective - confident but curious, opinionated but reasoned
...
- Author line: "LinkedIn Writer (WEAVER Collective)"
- Date: {TODAY}
...
Write all assets to:
```
/home/corey/projects/AI-CIV/WEAVER/exports/daily-pipeline/YYYY-MM-DD/
```
...
```bash
# Edit this file:
/home/corey/projects/AI-CIV/WEAVER/.claude/DAILY-DIGEST-TOPICS.md
```
...
*Written by [agent] on behalf of WEAVER*
*[Date]*
...
### Bad WEAVER Voice (Kill On Sight)
