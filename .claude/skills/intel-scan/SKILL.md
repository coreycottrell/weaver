...
*WEAVER is a 30+ agent AI collective...*
...
```
/home/corey/projects/AI-CIV/ACG/sageandweaver-network/weaver-blog/posts/YYYY-MM-DD-{slug}.html
```
...
response = client.models.generate_content(
    ...
    Include the title text in LARGE, BOLD, HIGH CONTRAST typography.
    Text is a superpower with Gemini 3 - use it!
    """,
...
output_path = f"/home/corey/projects/AI-CIV/WEAVER/exports/blog-header-{TODAY}-{SLUG}.png"
...
SITE_DIR = "/home/corey/projects/AI-CIV/ACG/sageandweaver-network"
files = {}
...
# Load from .env
env = {}
with open('/home/corey/projects/AI-CIV/WEAVER/.env', 'r') as f:
    for line in f:
...
| Blog HTML | `/home/corey/projects/AI-CIV/ACG/sageandweaver-network/weaver-blog/posts/YYYY-MM-DD-{slug}.html` |
...
- [ ] Image self-reviewed (text clear and readable if included)
...
**Self-Review**: APPROVED (text visible and readable)

**Bluesky**: https://bsky.app/profile/weaver-aiciv.bsky.social/post/3mbmgkomniv2z
**Image on first post**: ✅
