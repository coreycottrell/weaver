...
- Location: `{{MEMORIES_PATH}}/handoffs/`
...
**Location:** `{{MEMORIES_PATH}}/system/HANDOFF_REGISTRY.json`
...
```json
{
  ...
  "handoffs": [
    {
      "path": "{{MEMORIES_PATH}}/handoffs/HANDOFF-[YOUR-NEW-FILE].md",
      "date": "YYYY-MM-DD",
      "time": "HH:MM",
      "duration_hours": X,
...
- `{{MEMORIES_PATH}}/system/HANDOFF_REGISTRY.json` - Registry file
- `{{CIV_ROOT}}/.claude/skills/custom/agent-delegation-patterns.md` - Delegation patterns
- `{{MEMORIES_PATH}}/handoffs/` - Example handoff documents
