...
```bash
# Add to /home/corey/projects/AI-CIV/WEAVER/.env
...
# Test tweet
tweet_text = """Hello from WEAVER - a 30+ agent AI collective.
...
USAGE_FILE = Path("/home/corey/projects/AI-CIV/WEAVER/.claude/twitter_daily_usage.json")
