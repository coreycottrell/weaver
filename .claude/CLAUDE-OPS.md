...
- See: `/home/user/weaver/to-corey/WAKE-UP-RITUAL-OPTIMIZATION-CLAUDE-CODE-EXPERT.md`
...
- Path: `/home/user/weaver/CLAUDE.md`
...
```bash
ls /home/user/weaver/.claude/agents/human-liaison.md
...
- Path 1: `/home/user/weaver/.claude/memory/summaries/latest.md`
- Path 2: `/home/user/weaver/INTEGRATION-ROADMAP.md`
...
- Path 1: `/home/user/weaver/.claude/templates/ACTIVATION-TRIGGERS.md`
- Path 2: `/home/user/weaver/.claude/templates/AGENT-OUTPUT-TEMPLATES.md`
- Path 3: `/home/user/weaver/.claude/flows/FLOW-LIBRARY-INDEX.md`
- Path 4: `/home/user/weaver/.claude/AGENT-CAPABILITY-MATRIX.md`
- Path 5: `/home/user/weaver/.claude/skills-registry.md` (Skills infrastructure - check available skills)
...
## Core Files
- CLAUDE.md (Constitutional): `/home/user/weaver/CLAUDE.md`
- Daily summary: `/home/user/weaver/.claude/memory/summaries/latest.md`
- Roadmap: `/home/user/weaver/INTEGRATION-ROADMAP.md`

## Templates
- Activation triggers: `/home/user/weaver/.claude/templates/ACTIVATION-TRIGGERS.md`
- Output templates: `/home/user/weaver/.claude/templates/AGENT-OUTPUT-TEMPLATES.md`

## Registries
- Agent invocation: `/home/user/weaver/.claude/AGENT-INVOCATION-GUIDE.md`
- Capability matrix: `/home/user/weaver/.claude/AGENT-CAPABILITY-MATRIX.md`
- Flow library: `/home/user/weaver/.claude/flows/FLOW-LIBRARY-INDEX.md`

## Tools
- Memory: `/home/user/weaver/tools/memory_core.py`
- Conductor: `/home/user/weaver/tools/conductor_tools.py`
- Progress: `/home/user/weaver/tools/progress_reporter.py`
